...
from functions import stop_recording, browse_devices, start_streaming, fetch_attention_level, attention_alert
import threading
import os
import time
import random
...
def register_routes(app):
    ...
    async def browse_devices_route():
        ...
        """
        return jsonify(await browse_devices())
    ...
    async def start_streaming_route():
        ...
        try:
            ...
            result = await start_streaming(device_name)
